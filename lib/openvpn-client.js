...
module.exports = params => {
    ...
    const spawnOptions = params.spawnOptions;
    ...
    return Promise.all([
        ...
        .then(result => {
            ...
            const proc = nns.execNoWait(`openvpn ${config}`, spawnOptions);
    ...
    function makeParams(opts) {
        ...
        ['config', 'comp-lzo', 'remote', 'port', 'proto', 'dev', 'key-direction', 'cipher'].forEach(param => {
            if (opts[param]) {
